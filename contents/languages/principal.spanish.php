<?php
    ...
    const label_apellido = 'Apellido';
    const label_nombre_ayuda = 'Por favor coloque su nombre en este campo.';
    ...
    const label_presentacion_about = 'Hola! Mi nombre es %1$s, yo soy %2$s';
    const label_tu_nombre = 'Tu nombre';
    ...
    const btn_enviar_mensaje = 'Enviar Mensaje';
    //login
